      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-3 w-80 sm:w-96 rounded-[22px] bg-[#0A2034] border border-[#00A4B4]/35 shadow-[0_10px_40px_rgba(0,0,0,0.8)] z-50 text-white overflow-hidden backdrop-blur-xl"
          >
            {/* Dropdown Header */}
